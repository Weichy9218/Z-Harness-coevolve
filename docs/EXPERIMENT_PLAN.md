...
| Day 10 | MiniAPI v0 | 500 行以内 simulator；支持 hidden API constraints 和 deterministic verifier；复用 headroom / leakage / adoption 三套协议 | simulator + headroom/counterfactual smoke 已完成；memory proxy / adoption port 待做，见 [docs/result/DAY10_MINIAPI_SMOKE.md](result/DAY10_MINIAPI_SMOKE.md) |
